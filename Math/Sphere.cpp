...
std::vector <double>  Sphere::intersectionsWith(Ray ray){
	...
	Tuple o = worldRay.getOrigin() - Tuple::Point(0,0,0);
	double a = Tuple::dotProduct(worldRay.getDirection(), worldRay.getDirection());
	double b = 2 * Tuple::dotProduct(worldRay.getDirection(), o);
